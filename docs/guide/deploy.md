...
2. Inside your project, create `deploy.sh` with the following content (with highlighted lines uncommented appropriately). In the terminal/Cmd run deploy.sh (for example: `sh deploy.sh`) to deploy.
