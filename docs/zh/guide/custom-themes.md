...
``` json
{
  ...
  "pages": [
    {
      "birthtimeMs": 1524495591000,
      "mtimeMs": 1524495591000,
      "path": "/",
      "title": "VuePress",
      "frontmatter": {}
    },
...
``` json
{
  "birthtimeMs": 1524544404000,
  "mtimeMs": 1524544404000,
...
::: tip 提示
  `birthtimeMs` 和 `mtimeMs` 分别是 `文件的创建时间` 和 `文件最后被修改的时间`, 更多细节请参考 [Node.js 的文档](https://nodejs.org/dist/latest/docs/api/fs.html#fs_stat_time_values)。
:::
