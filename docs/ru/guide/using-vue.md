---
en: e7512a5d2aea19ae736e40a37bf139fef8ad97e0
---
...
Сгенерированный компонент не имеет собственных данных, но имеет доступ к [метаданным сайта](./custom-themes.md#метаданные-сайта-и-страницы). Например:
...
Вывод HTML выполняется с помощью [markdown-it](https://github.com/markdown-it/markdown-it), тогда как заголовки анализируются VuePress и используются для [Боковой панели](../default-theme-config/README.md#sidebar) и заголовок документа.
:::
...
Сгенерированное содержимое текущего файла `.md` Это будет очень полезно при использовании [Пользовательского Макета](../default-theme-config/README.md#пользовательский-макет-для-определенных-страниц).
...
- [Пользовательские темы > Содержание](./custom-themes.md#содержание)
